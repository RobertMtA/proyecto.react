...
import './BearAndBunny.css';  // Fixed CSS import

const BearAndBunny = () => {  // Remove addToCart prop
  ...
  const handleAddToCart = () => {
    ...
    const itemToAdd = {
      ...
      selectedColor,
      quantity,
      image: images[0], // Add this to ensure image shows in cart
